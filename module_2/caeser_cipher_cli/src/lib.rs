...
The encrypt function takes a plaintext string and a shift value, and returns the
ciphertext string.
...
pub fn encrypt(text: &str, shift: u8) -> String {
    ...
    // Cycle through characters, make lowercase and apply the appropriate shift
    for c in text.chars() {
